 ...
 * Shamelessly copied from the Linux kernel header linux/pci_regs.h
 * https://elixir.bootlin.com/linux/v6.17.7/source/include/uapi/linux/pci_regs.h
 *
 * Apologies to Drew Eckhardt and Martin Mares, who hold the original copyright.
 *
 * See also: 
